...
namespace Hexa.NET.D3D11
{
	...
	public partial struct ComputeShaderTraceDesc
	{
		/// <summary>
		/// To be documented.
		/// </summary>
		...
		/// To be documented.
		/// </summary>
		public unsafe ComputeShaderTraceDesc(ulong invocation = default, uint* threadIdInGroup = default, uint* threadGroupId = default)
		{
		...
		/// To be documented.
		/// </summary>
		public unsafe ComputeShaderTraceDesc(ulong invocation = default, Span<uint> threadIdInGroup = default, Span<uint> threadGroupId = default)
		{
			Invocation = invocation;
