...
namespace Hexa.NET.D3D11
{
	...
	public partial struct D3D11RenderTargetViewDesc1
	{
		...
		public partial struct D3D11RenderTargetViewDesc1Union
		{
			...
			/// To be documented.
			/// </summary>
			public unsafe D3D11RenderTargetViewDesc1Union(D3D11BufferRtv buffer = default, D3D11Tex1DRtv texture1D = default, D3D11Tex1DArrayRtv texture1DArray = default, D3D11Tex2DRtv1 texture2D = default, D3D11Tex2DArrayRtv1 texture2DArray = default, D3D11Tex2DmsRtv texture2Dms = default, D3D11Tex2DmsArrayRtv texture2DmsArray = default, D3D11Tex3DRtv texture3D = default)
			{
				Buffer = buffer;
				Texture1D = texture1D;
		...
		/// To be documented.
		/// </summary>
		public unsafe D3D11RenderTargetViewDesc1(DxgiFormat format = default, D3D11RtvDimension viewDimension = default, D3D11RenderTargetViewDesc1Union union = default)
		{
			Format = format;
