...
namespace Hexa.NET.D3D11
{
	...
	public partial struct D3D11RasterizerDesc2
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe D3D11RasterizerDesc2(D3D11FillMode fillMode = default, D3D11CullMode cullMode = default, int frontCounterClockwise = default, int depthBias = default, float depthBiasClamp = default, float slopeScaledDepthBias = default, int depthClipEnable = default, int scissorEnable = default, int multisampleEnable = default, int antialiasedLineEnable = default, uint forcedSampleCount = default, D3D11ConservativeRasterizationMode conservativeRaster = default)
		{
			FillMode = fillMode;
			CullMode = cullMode;
