...
namespace Hexa.NET.D3D12
{
	...
	public partial struct D3D12ShaderInputBindDesc
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe D3D12ShaderInputBindDesc(byte* name = default, D3DShaderInputType type = default, uint bindPoint = default, uint bindCount = default, uint uFlags = default, D3DResourceReturnType returnType = default, D3DSrvDimension dimension = default, uint numSamples = default, uint space = default, uint uiD = default)
		{
			Name = name;
			Type = type;
			BindPoint = bindPoint;
