...
namespace Hexa.NET.D3D12
{
	...
	public partial struct D3D12FeatureDataVideoEncoderIntraRefreshMode
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe D3D12FeatureDataVideoEncoderIntraRefreshMode(uint nodeIndex = default, D3D12VideoEncoderCodec codec = default, D3D12VideoEncoderProfileDesc profile = default, D3D12VideoEncoderLevelSetting level = default, D3D12VideoEncoderIntraRefreshMode intraRefreshMode = default, int isSupported = default)
		{
			NodeIndex = nodeIndex;
			Codec = codec;
			Profile = profile;
