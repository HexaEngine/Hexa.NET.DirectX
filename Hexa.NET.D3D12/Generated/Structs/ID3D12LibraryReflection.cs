...
namespace Hexa.NET.D3D12
{
	...
	public partial struct ID3D12LibraryReflection : IComObject, IComObject<ID3D12LibraryReflection>, IComObject<IUnknown>
	{
		...
		public readonly unsafe HResult QueryInterface(Guid* riid, void** ppvObject) 
		{
			...
			HResult ret = ((delegate* unmanaged[Stdcall]<ID3D12LibraryReflection*, Guid*, void**, HResult>)(*LpVtbl))(ptr, riid, ppvObject);
			return ret;
		}
		...
		public readonly unsafe HResult QueryInterface(ref Guid riid, void** ppvObject) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<ID3D12LibraryReflection*, Guid*, void**, HResult>)(*LpVtbl))(ptr, (Guid*)priid, ppvObject);
				return ret;
			}
		}
		...
		public readonly unsafe HResult QueryInterface<T>(out ComPtr<T> ppvObject) where T : unmanaged, IComObject, IComObject<T>
		{
			ID3D12LibraryReflection* ptr = (ID3D12LibraryReflection*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			ppvObject = default;
			HResult ret = ((delegate* unmanaged[Stdcall]<ID3D12LibraryReflection*, Guid*, void**, HResult>)(*LpVtbl))(ptr, (Guid*)(ComUtils.GuidPtrOf<T>()), (void**)ppvObject.GetAddressOf());
			return ret;
		}
		...
		public readonly unsafe HResult QueryInterface<T>(ref Guid riid, out ComPtr<T> ppvObject) where T : unmanaged, IComObject, IComObject<T>
		{
			...
			{
				ppvObject = default;
				HResult ret = ((delegate* unmanaged[Stdcall]<ID3D12LibraryReflection*, Guid*, void**, HResult>)(*LpVtbl))(ptr, (Guid*)priid, (void**)ppvObject.GetAddressOf());
				return ret;
			}
		}
		...
		public readonly unsafe HResult QueryInterface(Guid* iid, ref void* ppv) 
		{
			...
			fixed (void** pppv = &ppv)
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<ID3D12LibraryReflection*, Guid*, void**, HResult>)(LpVtbl[3]))(ptr, iid, (void**)pppv);
				return ret;
			}
		}
		...
		public readonly unsafe HResult QueryInterface(ref Guid iid, ref void* ppv) 
		{
			...
			fixed (Guid* piid = &iid)
			{
				fixed (void** pppv = &ppv)
				{
					HResult ret = ((delegate* unmanaged[Stdcall]<ID3D12LibraryReflection*, Guid*, void**, HResult>)(LpVtbl[3]))(ptr, (Guid*)piid, (void**)pppv);
					return ret;
				}
			}
		}
		...
		{
			ID3D12LibraryReflection* ptr = (ID3D12LibraryReflection*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<ID3D12LibraryReflection*, LibraryDesc*, HResult>)(LpVtbl[4]))(ptr, pDesc);
			return ret;
		}
		...
		public readonly unsafe HResult GetDesc(ref LibraryDesc pDesc) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<ID3D12LibraryReflection*, LibraryDesc*, HResult>)(LpVtbl[4]))(ptr, (LibraryDesc*)ppDesc);
				return ret;
			}
		}
