...
namespace Hexa.NET.D3D12
{
	...
	public partial struct D3D12FeatureDataVideoEncoderFrameSubregionLayoutMode
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe D3D12FeatureDataVideoEncoderFrameSubregionLayoutMode(uint nodeIndex = default, D3D12VideoEncoderCodec codec = default, D3D12VideoEncoderProfileDesc profile = default, D3D12VideoEncoderLevelSetting level = default, D3D12VideoEncoderFrameSubregionLayoutMode subregionMode = default, int isSupported = default)
		{
			NodeIndex = nodeIndex;
			Codec = codec;
			Profile = profile;
