...
namespace Hexa.NET.D3D12
{
	...
	public partial struct ID3D12VideoProcessor : IComObject, IComObject<ID3D12VideoProcessor>, IComObject<ID3D12Pageable>, IComObject<ID3D12DeviceChild>, IComObject<ID3D12Object>, IComObject<IUnknown>
	{
		...
		{
			ID3D12VideoProcessor* ptr = (ID3D12VideoProcessor*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			int ret = ((delegate* unmanaged[Stdcall]<ID3D12VideoProcessor*, uint, D3D12VideoProcessInputStreamDesc*, int>)(LpVtbl[10]))(ptr, numInputStreamDescs, pInputStreamDescs);
			return ret;
		}
		...
		public readonly unsafe int GetInputStreamDescs([NativeName(NativeNameType.Param, "NumInputStreamDescs")] [NativeName(NativeNameType.Type, "UINT")] uint numInputStreamDescs, [NativeName(NativeNameType.Param, "pInputStreamDescs")] [NativeName(NativeNameType.Type, "D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC*")] ref D3D12VideoProcessInputStreamDesc pInputStreamDescs) 
		{
			...
			{
				int ret = ((delegate* unmanaged[Stdcall]<ID3D12VideoProcessor*, uint, D3D12VideoProcessInputStreamDesc*, int>)(LpVtbl[10]))(ptr, numInputStreamDescs, (D3D12VideoProcessInputStreamDesc*)ppInputStreamDescs);
				return ret;
			}
		}
		...
		{
			ID3D12VideoProcessor* ptr = (ID3D12VideoProcessor*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			D3D12VideoProcessOutputStreamDesc ret = ((delegate* unmanaged[Stdcall]<ID3D12VideoProcessor*, D3D12VideoProcessOutputStreamDesc>)(LpVtbl[11]))(ptr);
			return ret;
		}
