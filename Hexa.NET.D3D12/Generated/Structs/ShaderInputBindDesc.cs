...
namespace Hexa.NET.D3D12
{
	...
	public partial struct ShaderInputBindDesc
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe ShaderInputBindDesc(byte* name = default, ShaderInputType type = default, uint bindPoint = default, uint bindCount = default, uint uFlags = default, ResourceReturnType returnType = default, SrvDimension dimension = default, uint numSamples = default, uint space = default, uint uiD = default)
		{
			Name = name;
			Type = type;
			BindPoint = bindPoint;
