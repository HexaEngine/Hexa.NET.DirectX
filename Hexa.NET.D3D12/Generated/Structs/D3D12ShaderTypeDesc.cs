...
namespace Hexa.NET.D3D12
{
	...
	public partial struct D3D12ShaderTypeDesc
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe D3D12ShaderTypeDesc(D3DShaderVariableClass @class = default, D3DShaderVariableType type = default, uint rows = default, uint columns = default, uint elements = default, uint members = default, uint offset = default, byte* name = default)
		{
			Class = @class;
			Type = type;
			Rows = rows;
