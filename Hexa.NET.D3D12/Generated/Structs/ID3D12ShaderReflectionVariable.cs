...
namespace Hexa.NET.D3D12
{
	...
	public partial struct ID3D12ShaderReflectionVariable : IComObject, IComObject<ID3D12ShaderReflectionVariable>
	{
		...
		public readonly unsafe HResult GetDesc(ShaderVariableDesc* pDesc) 
		{
			...
			HResult ret = ((delegate* unmanaged[Stdcall]<ID3D12ShaderReflectionVariable*, ShaderVariableDesc*, HResult>)(*LpVtbl))(ptr, pDesc);
			return ret;
		}
		...
		public readonly unsafe HResult GetDesc(ref ShaderVariableDesc pDesc) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<ID3D12ShaderReflectionVariable*, ShaderVariableDesc*, HResult>)(*LpVtbl))(ptr, (ShaderVariableDesc*)ppDesc);
				return ret;
			}
		}
