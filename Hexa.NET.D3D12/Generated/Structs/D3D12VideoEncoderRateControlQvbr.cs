...
namespace Hexa.NET.D3D12
{
	...
	public partial struct D3D12VideoEncoderRateControlQvbr
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe D3D12VideoEncoderRateControlQvbr(uint initialQp = default, uint minQp = default, uint maxQp = default, ulong maxFrameBitSize = default, ulong targetAvgBitRate = default, ulong peakBitRate = default, uint constantQualityTarget = default)
		{
			InitialQP = initialQp;
			MinQP = minQp;
			MaxQP = maxQp;
