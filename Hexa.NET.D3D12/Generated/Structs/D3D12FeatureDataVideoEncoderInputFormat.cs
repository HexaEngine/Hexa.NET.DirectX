...
namespace Hexa.NET.D3D12
{
	...
	public partial struct D3D12FeatureDataVideoEncoderInputFormat
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe D3D12FeatureDataVideoEncoderInputFormat(uint nodeIndex = default, D3D12VideoEncoderCodec codec = default, D3D12VideoEncoderProfileDesc profile = default, DxgiFormat format = default, int isSupported = default)
		{
			NodeIndex = nodeIndex;
			Codec = codec;
			Profile = profile;
