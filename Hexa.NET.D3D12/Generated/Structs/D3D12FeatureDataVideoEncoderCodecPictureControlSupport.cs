...
namespace Hexa.NET.D3D12
{
	...
	public partial struct D3D12FeatureDataVideoEncoderCodecPictureControlSupport
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe D3D12FeatureDataVideoEncoderCodecPictureControlSupport(uint nodeIndex = default, D3D12VideoEncoderCodec codec = default, D3D12VideoEncoderProfileDesc profile = default, int isSupported = default, D3D12VideoEncoderCodecPictureControlSupport pictureSupport = default)
		{
			NodeIndex = nodeIndex;
			Codec = codec;
			Profile = profile;
