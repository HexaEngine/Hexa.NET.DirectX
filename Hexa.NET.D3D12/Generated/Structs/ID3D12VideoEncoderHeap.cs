...
namespace Hexa.NET.D3D12
{
	...
	public partial struct ID3D12VideoEncoderHeap : IComObject, IComObject<ID3D12VideoEncoderHeap>, IComObject<ID3D12Pageable>, IComObject<ID3D12DeviceChild>, IComObject<ID3D12Object>, IComObject<IUnknown>
	{
		...
		{
			ID3D12VideoEncoderHeap* ptr = (ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			int ret = ((delegate* unmanaged[Stdcall]<ID3D12VideoEncoderHeap*, VideoEncoderProfileDesc, int>)(LpVtbl[11]))(ptr, dstProfile);
			return ret;
		}
		...
		/// To be documented.
		/// </summary>
		public readonly unsafe int GetCodecLevel(VideoEncoderLevelSetting dstLevel) 
		{
			ID3D12VideoEncoderHeap* ptr = (ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			int ret = ((delegate* unmanaged[Stdcall]<ID3D12VideoEncoderHeap*, VideoEncoderLevelSetting, int>)(LpVtbl[12]))(ptr, dstLevel);
			return ret;
		}
		...
		{
			ID3D12VideoEncoderHeap* ptr = (ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			int ret = ((delegate* unmanaged[Stdcall]<ID3D12VideoEncoderHeap*, uint, VideoEncoderPictureResolutionDesc*, int>)(LpVtbl[14]))(ptr, resolutionsListCount, pResolutionList);
			return ret;
		}
		...
		/// To be documented.
		/// </summary>
		public readonly unsafe int GetResolutionList(uint resolutionsListCount, ref VideoEncoderPictureResolutionDesc pResolutionList) 
		{
			ID3D12VideoEncoderHeap* ptr = (ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			fixed (VideoEncoderPictureResolutionDesc* ppResolutionList = &pResolutionList)
			{
				int ret = ((delegate* unmanaged[Stdcall]<ID3D12VideoEncoderHeap*, uint, VideoEncoderPictureResolutionDesc*, int>)(LpVtbl[14]))(ptr, resolutionsListCount, (VideoEncoderPictureResolutionDesc*)ppResolutionList);
				return ret;
			}
		}
