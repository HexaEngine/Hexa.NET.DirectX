...
namespace Hexa.NET.D3D12
{
	...
	public partial struct VideoProcessInputStreamArguments1
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe VideoProcessInputStreamArguments1(VideoProcessInputStream* inputStream = default, VideoProcessTransform transform = default, VideoProcessInputStreamFlags flags = default, VideoProcessInputStreamRate rateInfo = default, int* filterLevels = default, VideoProcessAlphaBlending alphaBlending = default, VideoFieldType fieldType = default)
		{
		...
		/// To be documented.
		/// </summary>
		public unsafe VideoProcessInputStreamArguments1(Span<VideoProcessInputStream> inputStream = default, VideoProcessTransform transform = default, VideoProcessInputStreamFlags flags = default, VideoProcessInputStreamRate rateInfo = default, Span<int> filterLevels = default, VideoProcessAlphaBlending alphaBlending = default, VideoFieldType fieldType = default)
		{
