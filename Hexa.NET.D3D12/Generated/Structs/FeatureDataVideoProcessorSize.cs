...
namespace Hexa.NET.D3D12
{
	...
	public partial struct FeatureDataVideoProcessorSize
	{
		/// <summary>
		/// To be documented.
		/// </summary>
		...
		/// To be documented.
		/// </summary>
		public unsafe FeatureDataVideoProcessorSize(uint nodeMask = default, VideoProcessOutputStreamDesc* pOutputStreamDesc = default, uint numInputStreamDescs = default, VideoProcessInputStreamDesc* pInputStreamDescs = default, ulong memoryPoolL0Size = default, ulong memoryPoolL1Size = default)
		{
			NodeMask = nodeMask;
