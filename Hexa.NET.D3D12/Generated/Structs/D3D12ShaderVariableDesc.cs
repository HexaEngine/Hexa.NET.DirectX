...
namespace Hexa.NET.D3D12
{
	...
	public partial struct D3D12ShaderVariableDesc
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe D3D12ShaderVariableDesc(byte* name = default, uint startOffset = default, uint size = default, uint uFlags = default, void* defaultValue = default, uint startTexture = default, uint textureSize = default, uint startSampler = default, uint samplerSize = default)
		{
			Name = name;
