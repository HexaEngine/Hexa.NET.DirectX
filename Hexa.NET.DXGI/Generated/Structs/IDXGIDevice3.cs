...
namespace Hexa.NET.DXGI
{
	...
	public partial struct IDXGIDevice3 : IComObject, IComObject<IDXGIDevice3>, IComObject<IDXGIDevice2>, IComObject<IDXGIDevice1>, IComObject<IDXGIDevice>, IComObject<IDXGIObject>, IComObject<IUnknown>
	{
		...
		{
			IDXGIDevice3* ptr = (IDXGIDevice3*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, Guid*, IUnknown*, HResult>)(LpVtbl[4]))(ptr, name, (IUnknown*)pUnknown.Handle);
			return ret;
		}
		...
		public readonly unsafe HResult SetPrivateDataInterface(ref Guid name, ComPtr<IUnknown> pUnknown) 
		{
			...
			fixed (Guid* pname = &name)
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, Guid*, IUnknown*, HResult>)(LpVtbl[4]))(ptr, (Guid*)pname, (IUnknown*)pUnknown.Handle);
				return ret;
			}
		}
		...
		{
			IDXGIDevice3* ptr = (IDXGIDevice3*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, Guid*, uint*, void*, HResult>)(LpVtbl[5]))(ptr, name, pDataSize, (void*)pData.Handle);
			return ret;
		}
		...
		public readonly unsafe HResult GetPrivateData<T>(ref Guid name, uint* pDataSize, ComPtr<T> pData) where T : unmanaged, IComObject, IComObject<T>
		{
			...
			fixed (Guid* pname = &name)
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, Guid*, uint*, void*, HResult>)(LpVtbl[5]))(ptr, (Guid*)pname, pDataSize, (void*)pData.Handle);
				return ret;
			}
		}
		...
		public readonly unsafe HResult GetPrivateData<T>(Guid* name, ref uint pDataSize, ComPtr<T> pData) where T : unmanaged, IComObject, IComObject<T>
		{
			...
			fixed (uint* ppDataSize = &pDataSize)
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, Guid*, uint*, void*, HResult>)(LpVtbl[5]))(ptr, name, (uint*)ppDataSize, (void*)pData.Handle);
				return ret;
			}
		}
		...
		public readonly unsafe HResult GetPrivateData<T>(ref Guid name, ref uint pDataSize, ComPtr<T> pData) where T : unmanaged, IComObject, IComObject<T>
		{
			...
			fixed (Guid* pname = &name)
			{
				fixed (uint* ppDataSize = &pDataSize)
				{
					HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, Guid*, uint*, void*, HResult>)(LpVtbl[5]))(ptr, (Guid*)pname, (uint*)ppDataSize, (void*)pData.Handle);
					return ret;
				}
			}
		}
		...
		{
			IDXGIDevice3* ptr = (IDXGIDevice3*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, pDesc, numSurfaces, usage, pSharedResource, ppSurface);
			return ret;
		}
		...
		public readonly unsafe HResult CreateSurface(ref SurfaceDesc pDesc, uint numSurfaces, uint usage, SharedResource* pSharedResource, IDXGISurface** ppSurface) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, (SurfaceDesc*)ppDesc, numSurfaces, usage, pSharedResource, ppSurface);
				return ret;
			}
		}
		...
		public readonly unsafe HResult CreateSurface(SurfaceDesc* pDesc, uint numSurfaces, uint usage, ref SharedResource pSharedResource, IDXGISurface** ppSurface) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, pDesc, numSurfaces, usage, (SharedResource*)ppSharedResource, ppSurface);
				return ret;
			}
		}
		...
		public readonly unsafe HResult CreateSurface(ref SurfaceDesc pDesc, uint numSurfaces, uint usage, ref SharedResource pSharedResource, IDXGISurface** ppSurface) 
		{
			...
			fixed (SurfaceDesc* ppDesc = &pDesc)
			{
				fixed (SharedResource* ppSharedResource = &pSharedResource)
				{
					HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, (SurfaceDesc*)ppDesc, numSurfaces, usage, (SharedResource*)ppSharedResource, ppSurface);
					return ret;
				}
			}
		}
		...
		public readonly unsafe HResult CreateSurface(SurfaceDesc* pDesc, uint numSurfaces, uint usage, SharedResource* pSharedResource, ref IDXGISurface* ppSurface) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, pDesc, numSurfaces, usage, pSharedResource, (IDXGISurface**)pppSurface);
				return ret;
			}
		}
		...
		public readonly unsafe HResult CreateSurface(SurfaceDesc* pDesc, uint numSurfaces, uint usage, SharedResource* pSharedResource, out ComPtr<IDXGISurface> ppSurface) 
		{
			IDXGIDevice3* ptr = (IDXGIDevice3*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			ppSurface = default;
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, pDesc, numSurfaces, usage, pSharedResource, (IDXGISurface**)ppSurface.GetAddressOf());
			return ret;
		}
		...
		public readonly unsafe HResult CreateSurface(ref SurfaceDesc pDesc, uint numSurfaces, uint usage, SharedResource* pSharedResource, ref IDXGISurface* ppSurface) 
		{
			...
			fixed (SurfaceDesc* ppDesc = &pDesc)
			{
				fixed (IDXGISurface** pppSurface = &ppSurface)
				{
					HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, (SurfaceDesc*)ppDesc, numSurfaces, usage, pSharedResource, (IDXGISurface**)pppSurface);
					return ret;
				}
			}
		}
		...
		public readonly unsafe HResult CreateSurface(ref SurfaceDesc pDesc, uint numSurfaces, uint usage, SharedResource* pSharedResource, out ComPtr<IDXGISurface> ppSurface) 
		{
			...
			{
				ppSurface = default;
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, (SurfaceDesc*)ppDesc, numSurfaces, usage, pSharedResource, (IDXGISurface**)ppSurface.GetAddressOf());
				return ret;
			}
		}
		...
		public readonly unsafe HResult CreateSurface(SurfaceDesc* pDesc, uint numSurfaces, uint usage, ref SharedResource pSharedResource, ref IDXGISurface* ppSurface) 
		{
			...
			fixed (SharedResource* ppSharedResource = &pSharedResource)
			{
				fixed (IDXGISurface** pppSurface = &ppSurface)
				{
					HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, pDesc, numSurfaces, usage, (SharedResource*)ppSharedResource, (IDXGISurface**)pppSurface);
					return ret;
				}
			}
		}
		...
		public readonly unsafe HResult CreateSurface(SurfaceDesc* pDesc, uint numSurfaces, uint usage, ref SharedResource pSharedResource, out ComPtr<IDXGISurface> ppSurface) 
		{
			...
			{
				ppSurface = default;
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, pDesc, numSurfaces, usage, (SharedResource*)ppSharedResource, (IDXGISurface**)ppSurface.GetAddressOf());
				return ret;
			}
		}
		...
		public readonly unsafe HResult CreateSurface(ref SurfaceDesc pDesc, uint numSurfaces, uint usage, ref SharedResource pSharedResource, ref IDXGISurface* ppSurface) 
		{
			...
			fixed (SurfaceDesc* ppDesc = &pDesc)
			{
				fixed (SharedResource* ppSharedResource = &pSharedResource)
				{
					fixed (IDXGISurface** pppSurface = &ppSurface)
					{
						HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, (SurfaceDesc*)ppDesc, numSurfaces, usage, (SharedResource*)ppSharedResource, (IDXGISurface**)pppSurface);
						return ret;
					}
				}
			}
		...
		public readonly unsafe HResult CreateSurface(ref SurfaceDesc pDesc, uint numSurfaces, uint usage, ref SharedResource pSharedResource, out ComPtr<IDXGISurface> ppSurface) 
		{
			...
			fixed (SurfaceDesc* ppDesc = &pDesc)
			{
				...
				{
					ppSurface = default;
					HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, SurfaceDesc*, uint, uint, SharedResource*, IDXGISurface**, HResult>)(LpVtbl[8]))(ptr, (SurfaceDesc*)ppDesc, numSurfaces, usage, (SharedResource*)ppSharedResource, (IDXGISurface**)ppSurface.GetAddressOf());
					return ret;
				}
			}
		}
		...
		{
			IDXGIDevice3* ptr = (IDXGIDevice3*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, IUnknown**, Residency*, uint, HResult>)(LpVtbl[9]))(ptr, ppResources, pResidencyStatus, numResources);
			return ret;
		}
		...
		public readonly unsafe HResult QueryResourceResidency(ref IUnknown* ppResources, Residency* pResidencyStatus, uint numResources) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, IUnknown**, Residency*, uint, HResult>)(LpVtbl[9]))(ptr, (IUnknown**)pppResources, pResidencyStatus, numResources);
				return ret;
			}
		}
		...
		{
			IDXGIDevice3* ptr = (IDXGIDevice3*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, IUnknown**, Residency*, uint, HResult>)(LpVtbl[9]))(ptr, (IUnknown**)ppResources.Handle, pResidencyStatus, numResources);
			return ret;
		}
		...
		public readonly unsafe HResult QueryResourceResidency(IUnknown** ppResources, ref Residency pResidencyStatus, uint numResources) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, IUnknown**, Residency*, uint, HResult>)(LpVtbl[9]))(ptr, ppResources, (Residency*)ppResidencyStatus, numResources);
				return ret;
			}
		}
		...
		public readonly unsafe HResult QueryResourceResidency(ref IUnknown* ppResources, ref Residency pResidencyStatus, uint numResources) 
		{
			...
			fixed (IUnknown** pppResources = &ppResources)
			{
				fixed (Residency* ppResidencyStatus = &pResidencyStatus)
				{
					HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, IUnknown**, Residency*, uint, HResult>)(LpVtbl[9]))(ptr, (IUnknown**)pppResources, (Residency*)ppResidencyStatus, numResources);
					return ret;
				}
			}
		}
		...
		public readonly unsafe HResult QueryResourceResidency(ComPtr<IUnknown> ppResources, ref Residency pResidencyStatus, uint numResources) 
		{
			...
			fixed (Residency* ppResidencyStatus = &pResidencyStatus)
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, IUnknown**, Residency*, uint, HResult>)(LpVtbl[9]))(ptr, (IUnknown**)ppResources.Handle, (Residency*)ppResidencyStatus, numResources);
				return ret;
			}
		}
		...
		{
			IDXGIDevice3* ptr = (IDXGIDevice3*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, uint, IDXGIResource**, OfferResourcePriority, HResult>)(LpVtbl[14]))(ptr, numResources, ppResources, priority);
			return ret;
		}
		...
		public readonly unsafe HResult OfferResources(uint numResources, ref IDXGIResource* ppResources, OfferResourcePriority priority) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, uint, IDXGIResource**, OfferResourcePriority, HResult>)(LpVtbl[14]))(ptr, numResources, (IDXGIResource**)pppResources, priority);
				return ret;
			}
		}
		...
		{
			IDXGIDevice3* ptr = (IDXGIDevice3*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, uint, IDXGIResource**, OfferResourcePriority, HResult>)(LpVtbl[14]))(ptr, numResources, (IDXGIResource**)ppResources.Handle, priority);
			return ret;
		}
		...
		{
			IDXGIDevice3* ptr = (IDXGIDevice3*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, uint, IDXGIResource**, Bool32*, HResult>)(LpVtbl[15]))(ptr, numResources, (IDXGIResource**)ppResources.Handle, pDiscarded);
			return ret;
		}
		...
		public readonly unsafe HResult ReclaimResources(uint numResources, ComPtr<IDXGIResource> ppResources, ref Bool32 pDiscarded) 
		{
			...
			fixed (Bool32* ppDiscarded = &pDiscarded)
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIDevice3*, uint, IDXGIResource**, Bool32*, HResult>)(LpVtbl[15]))(ptr, numResources, (IDXGIResource**)ppResources.Handle, (Bool32*)ppDiscarded);
				return ret;
			}
		}
