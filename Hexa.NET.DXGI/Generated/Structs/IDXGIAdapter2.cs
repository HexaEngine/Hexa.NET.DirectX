...
namespace Hexa.NET.DXGI
{
	...
	public partial struct IDXGIAdapter2 : IComObject, IComObject<IDXGIAdapter2>, IComObject<IDXGIAdapter1>, IComObject<IDXGIAdapter>, IComObject<IDXGIObject>, IComObject<IUnknown>
	{
		...
		{
			IDXGIAdapter2* ptr = (IDXGIAdapter2*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, Guid*, IUnknown*, HResult>)(LpVtbl[4]))(ptr, name, (IUnknown*)pUnknown.Handle);
			return ret;
		}
		...
		public readonly unsafe HResult SetPrivateDataInterface(ref Guid name, ComPtr<IUnknown> pUnknown) 
		{
			...
			fixed (Guid* pname = &name)
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, Guid*, IUnknown*, HResult>)(LpVtbl[4]))(ptr, (Guid*)pname, (IUnknown*)pUnknown.Handle);
				return ret;
			}
		}
		...
		{
			IDXGIAdapter2* ptr = (IDXGIAdapter2*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, Guid*, uint*, void*, HResult>)(LpVtbl[5]))(ptr, name, pDataSize, (void*)pData.Handle);
			return ret;
		}
		...
		public readonly unsafe HResult GetPrivateData<T>(ref Guid name, uint* pDataSize, ComPtr<T> pData) where T : unmanaged, IComObject, IComObject<T>
		{
			...
			fixed (Guid* pname = &name)
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, Guid*, uint*, void*, HResult>)(LpVtbl[5]))(ptr, (Guid*)pname, pDataSize, (void*)pData.Handle);
				return ret;
			}
		}
		...
		public readonly unsafe HResult GetPrivateData<T>(Guid* name, ref uint pDataSize, ComPtr<T> pData) where T : unmanaged, IComObject, IComObject<T>
		{
			...
			fixed (uint* ppDataSize = &pDataSize)
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, Guid*, uint*, void*, HResult>)(LpVtbl[5]))(ptr, name, (uint*)ppDataSize, (void*)pData.Handle);
				return ret;
			}
		}
		...
		public readonly unsafe HResult GetPrivateData<T>(ref Guid name, ref uint pDataSize, ComPtr<T> pData) where T : unmanaged, IComObject, IComObject<T>
		{
			...
			fixed (Guid* pname = &name)
			{
				fixed (uint* ppDataSize = &pDataSize)
				{
					HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, Guid*, uint*, void*, HResult>)(LpVtbl[5]))(ptr, (Guid*)pname, (uint*)ppDataSize, (void*)pData.Handle);
					return ret;
				}
			}
		}
		...
		{
			IDXGIAdapter2* ptr = (IDXGIAdapter2*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, AdapterDesc*, HResult>)(LpVtbl[8]))(ptr, pDesc);
			return ret;
		}
		...
		public readonly unsafe HResult GetDesc(ref AdapterDesc pDesc) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, AdapterDesc*, HResult>)(LpVtbl[8]))(ptr, (AdapterDesc*)ppDesc);
				return ret;
			}
		}
		...
		{
			IDXGIAdapter2* ptr = (IDXGIAdapter2*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, AdapterDesc1*, HResult>)(LpVtbl[10]))(ptr, pDesc);
			return ret;
		}
		...
		public readonly unsafe HResult GetDesc1(ref AdapterDesc1 pDesc) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, AdapterDesc1*, HResult>)(LpVtbl[10]))(ptr, (AdapterDesc1*)ppDesc);
				return ret;
			}
		}
		...
		{
			IDXGIAdapter2* ptr = (IDXGIAdapter2*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, AdapterDesc2*, HResult>)(LpVtbl[11]))(ptr, pDesc);
			return ret;
		}
		...
		public readonly unsafe HResult GetDesc2(ref AdapterDesc2 pDesc) 
		{
			...
			{
				HResult ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter2*, AdapterDesc2*, HResult>)(LpVtbl[11]))(ptr, (AdapterDesc2*)ppDesc);
				return ret;
			}
		}
