...
namespace Hexa.NET.DXGI
{
	...
	public partial struct DisplayColorSpace
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe DisplayColorSpace(float** primaryCoordinates = default, float** whitePoints = default)
		{
		...
		/// To be documented.
		/// </summary>
		public unsafe DisplayColorSpace(Span<Pointer<float>> primaryCoordinates = default, Span<Pointer<float>> whitePoints = default)
		{
