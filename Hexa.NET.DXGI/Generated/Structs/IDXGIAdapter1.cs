...
namespace Hexa.NET.DXGI
{
	...
	public partial struct IDXGIAdapter1 : IComObject, IComObject<IDXGIAdapter1>, IComObject<IDXGIAdapter>, IComObject<IDXGIObject>, IComObject<IUnknown>
	{
		...
		{
			IDXGIAdapter1* ptr = (IDXGIAdapter1*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			int ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter1*, AdapterDesc*, int>)(LpVtbl[8]))(ptr, pDesc);
			return ret;
		}
		...
		public readonly unsafe int GetDesc(ref AdapterDesc pDesc) 
		{
			...
			{
				int ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter1*, AdapterDesc*, int>)(LpVtbl[8]))(ptr, (AdapterDesc*)ppDesc);
				return ret;
			}
		}
		...
		{
			IDXGIAdapter1* ptr = (IDXGIAdapter1*)Unsafe.AsPointer(ref Unsafe.AsRef(in this));
			int ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter1*, AdapterDesc1*, int>)(LpVtbl[10]))(ptr, pDesc);
			return ret;
		}
		...
		public readonly unsafe int GetDesc1(ref AdapterDesc1 pDesc) 
		{
			...
			{
				int ret = ((delegate* unmanaged[Stdcall]<IDXGIAdapter1*, AdapterDesc1*, int>)(LpVtbl[10]))(ptr, (AdapterDesc1*)ppDesc);
				return ret;
			}
		}
