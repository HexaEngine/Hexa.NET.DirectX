...
namespace Hexa.NET.DXGI
{
	...
	public partial struct JpegDcHuffmanTable
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe JpegDcHuffmanTable(byte* codeCounts = default, byte* codeValues = default)
		{
		...
		/// To be documented.
		/// </summary>
		public unsafe JpegDcHuffmanTable(Span<byte> codeCounts = default, Span<byte> codeValues = default)
		{
