...
namespace Hexa.NET.DXGI
{
	...
	public partial struct JpegAcHuffmanTable
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe JpegAcHuffmanTable(byte* codeCounts = default, byte* codeValues = default)
		{
		...
		/// To be documented.
		/// </summary>
		public unsafe JpegAcHuffmanTable(Span<byte> codeCounts = default, Span<byte> codeValues = default)
		{
