...
namespace Hexa.NET.DXGI
{
	...
	public partial struct AdapterDesc
	{
		/// <summary>
		/// To be documented.
		/// </summary>
		...
		/// To be documented.
		/// </summary>
		public unsafe AdapterDesc(char* description = default, uint vendorId = default, uint deviceId = default, uint subSysId = default, uint revision = default, nuint dedicatedVideoMemory = default, nuint dedicatedSystemMemory = default, nuint sharedSystemMemory = default, Luid adapterLuid = default)
		{
		...
		/// To be documented.
		/// </summary>
		public unsafe AdapterDesc(Span<char> description = default, uint vendorId = default, uint deviceId = default, uint subSysId = default, uint revision = default, nuint dedicatedVideoMemory = default, nuint dedicatedSystemMemory = default, nuint sharedSystemMemory = default, Luid adapterLuid = default)
		{
