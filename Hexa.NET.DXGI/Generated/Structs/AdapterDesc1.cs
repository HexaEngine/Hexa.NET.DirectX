...
namespace Hexa.NET.DXGI
{
	...
	public partial struct AdapterDesc1
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe AdapterDesc1(char* description = default, uint vendorId = default, uint deviceId = default, uint subSysId = default, uint revision = default, nuint dedicatedVideoMemory = default, nuint dedicatedSystemMemory = default, nuint sharedSystemMemory = default, Luid adapterLuid = default, uint flags = default)
		{
		...
		/// To be documented.
		/// </summary>
		public unsafe AdapterDesc1(Span<char> description = default, uint vendorId = default, uint deviceId = default, uint subSysId = default, uint revision = default, nuint dedicatedVideoMemory = default, nuint dedicatedSystemMemory = default, nuint sharedSystemMemory = default, Luid adapterLuid = default, uint flags = default)
		{
