...
namespace Hexa.NET.DXGI
{
	...
	public partial struct AdapterDesc2
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe AdapterDesc2(char* description = default, uint vendorId = default, uint deviceId = default, uint subSysId = default, uint revision = default, nuint dedicatedVideoMemory = default, nuint dedicatedSystemMemory = default, nuint sharedSystemMemory = default, Luid adapterLuid = default, uint flags = default, GraphicsPreemptionGranularity graphicsPreemptionGranularity = default, ComputePreemptionGranularity computePreemptionGranularity = default)
		{
		...
		/// To be documented.
		/// </summary>
		public unsafe AdapterDesc2(Span<char> description = default, uint vendorId = default, uint deviceId = default, uint subSysId = default, uint revision = default, nuint dedicatedVideoMemory = default, nuint dedicatedSystemMemory = default, nuint sharedSystemMemory = default, Luid adapterLuid = default, uint flags = default, GraphicsPreemptionGranularity graphicsPreemptionGranularity = default, ComputePreemptionGranularity computePreemptionGranularity = default)
		{
